<template>
    <div>
        ...
        <div class="project_artical center" v-for="(artical, index) in   projectArticalsList  " :key="index">
            ...
            <div class="slider">
                <svg class="slider__svg" xmlns="http://www.w3.org/2000/svg" width="172" height="172" viewBox="0 0 172 172"
                    fill="none">
                ...
                <img class="project_artical-img" :src=artical.image alt="photo">
                <button class="slider__btn"><img src="../assets/pag.svg" alt=""></button>
            </div>
